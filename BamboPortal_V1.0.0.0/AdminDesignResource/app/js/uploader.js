$(document).ready(function () {
    ...
    $("body").on("click", ".relogal-btn", function () {
        mApp.block("#uploader", {
            ...
            success: function (data) {
                ...
                $(".UploadEndsForWork").on("click", function () {
                    ...
                    if ($("#Savedimgs").length > 0) {
                        ...
                        strofSliderImfgs += $("#Savedimgs").val();
                    }
                    ...
                    if (ImgsforSlider[0].Allimgs.length == 0) {
    ...
    function generateSliderItem(objsenderss, k) {
        ...
        return '<div class="mySlides" style="display: ' + noneorBlock + ';position: relative" > <img src="' + objsenderss.thimnail + '" data-url="' + objsenderss.ImageBigSrc + '" style="width:100%" onerror="this.onerror=null;this.src=\'/CustomerSide_desinerResource/images/shop/imgNotFount.jpg\'" /></div>';
